  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/img/pcr-logo.png') ?>" rel="icon">
  ...
  <link href="<?= base_url('assets/template/assets/css/variables.css') ?>" rel="stylesheet">
  ...
  <link href="<?= base_url('assets/template/assets/css/main.css') ?>" rel="stylesheet">
